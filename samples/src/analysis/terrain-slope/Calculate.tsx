...
import { createCanvasFromSlope, degreesToRadians } from "./utils.ts";
import { useCallback } from "preact/hooks";
import { Forma } from "forma-embedded-view-sdk/auto";
import { CANVAS_NAME, SCALE } from "./TerrainSlope.tsx";
import { saveCanvas, saveFloatArray } from "./storage.ts";
...
export default function CalculateAndStore({ steepnessThreshold }: Props) {
  const calculateTerrainSteepness = useCallback(async () => {
    ...
    const terrainSlope = new Float32Array(width * height).fill(NaN);
